                ...
                if ($loop->have_posts()) :
                    while ($loop->have_posts()):
                        ...
                        <div class="bg-item item <?php echo ($i == 0) ? ' active ' : '' ?>">
                            <div class="col-md-12 bg-item">
                                <div class="col-xs-12 col-md-6 bg-item main-text-design nopadding" data-wow-delay="1s">
                                    <h4><?php the_title() ?></h4>
                                ...
                                <div class="col-xs-12 col-md-6 bg-item main-img-design nopadding" data-wow-delay="1s">
                                    <?php
                        ...
                        if ($loop->have_posts()) :
                            while ($loop->have_posts()):
                                ...
                                <li data-target="#myCarousel" data-slide-to="<?php echo $i ?>" class="<?php echo ($i == 0) ? 'active' : '' ?>">
                                    ...
                                    <article id="item-<?php the_ID() ?>" class="c-anchor mico mico-<?php echo get_field('icon_style') ?>"></article>
                                </li>
                                <?php
                                $i++;
                            endwhile;
